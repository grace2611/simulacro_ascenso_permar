...
{ pregunta: "¿Cuál es el lago navegablemás alto del mundo? Con 3,812 metros sobre el nivel del mar (msnm)", opciones: ["Lago Titicaca (Perú)", "Lago Poopó (Bolivia)", "Lago Ness (Escocia, Reino Unido)", "Lago Victoria (África: Tanzania, Uganda y Kenia)"], correcta: 0, fuente: "Instituto Geográfico Nacional (IGN). (2021). Atlas del Perú: Geografía y economía. Instituto Geográfico Nacional." },
